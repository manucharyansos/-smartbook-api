...
<head>
  ...
  <title>Ամրագրումը չեղարկվել է</title>
</head>
...
<div style="max-width:680px;margin:0 auto;padding:28px 14px;">
  <div style="background:linear-gradient(135deg,#ef4444 0%,#f97316 52%,#f59e0b 100%);border-radius:30px;padding:34px 28px;color:#fff;box-shadow:0 24px 60px rgba(15,23,42,.16);">
    <div style="font-size:12px;letter-spacing:.12em;text-transform:uppercase;opacity:.85;">Vizit</div>
    <h1 style="margin:14px 0 10px;font-size:30px;line-height:1.15;">Ամրագրումը չեղարկվել է</h1>
    <p style="margin:0;font-size:15px;line-height:1.75;color:rgba(255,255,255,.92);">Ձեր ամրագրումը հաջողությամբ չեղարկվել է։ Եթե սա արվել է սխալմամբ, կարող եք ստեղծել նոր ամրագրում ցանկացած հարմար պահին։</p>
  </div>
  ...
  <div style="margin-top:18px;background:#ffffff;border-radius:28px;padding:28px;border:1px solid #e2e8f0;box-shadow:0 18px 42px rgba(15,23,42,.08);">
    <div style="display:inline-block;padding:8px 14px;border-radius:999px;background:#fee2e2;color:#991b1b;font-size:12px;font-weight:700;">Չեղարկված</div>
    ...
    <p style="margin:22px 0 0;font-size:13px;line-height:1.75;color:#64748b;">
      Եթե ցանկանում եք, կարող եք նույն պահին ստեղծել նոր ամրագրում և ընտրել մեկ այլ ազատ ժամ։
    </p>
  </div>
</div>
</body>
